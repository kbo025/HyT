...
class ContainsOwnerProfile
{
     ...
     * @return \Validator
     */
    public static function editOwnerProfile($object, ExecutionContextInterface $context)
    {
        if ($object->get('user_id')) {
            $rpUser = RepositoryFactory::get('OwnerProfile');
     ...
     * @return \Validator
     */
    public static function createOwnerProfile($object, ExecutionContextInterface $context)
    {
